...
const NAV_ITEMS = [
  ...
  // ── Shared section ──
  { path: '/admin/batches',       label: 'Batches',         icon: '📅', superOnly: false },
...
export default function AdminLayout() {
  ...
  const [sideOpen, setSideOpen] = useState(true); // sidebar open/closed (mobile)
          ...
          {visibleNav.map((item) => (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                // Locked items for normal admin would appear here if we showed them
              })}
            >
