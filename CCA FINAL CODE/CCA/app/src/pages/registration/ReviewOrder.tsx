...
function ReviewOrder() {
  ...
  const perStudentFee = selectedBatch?.fee ?? selectedProgram?.basePrice ?? 0;
  const subtotal = perStudentFee * students.length;
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-lg">
              ...
              <div className="mt-4 space-y-3 rounded-2xl bg-slate-50 p-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-[#0F172A]">${perStudentFee}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-600">Students</span>
                  <span className="font-semibold text-[#0F172A]">× {students.length}</span>
                </div>
                <div className="flex justify-between text-sm">
